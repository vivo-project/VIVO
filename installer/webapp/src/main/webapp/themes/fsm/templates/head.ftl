...
<title>${(title?html)!siteName!} | Northwestern University - VIVO</title>
...
<link rel="shortcut icon" type="image/x-icon" href="http://www.feinberg.northwestern.edu/favicon.ico" />