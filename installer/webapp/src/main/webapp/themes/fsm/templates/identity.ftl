...
<header id="branding" role="banner">
    ...
    <div id="NM-hdr">
        <div id="NMLogo">
          <a href="http://www.nm.org" onclick="_gaq.push(['_trackEvent', 'banner-link', 'Click', 'www.nm.org']);"><span class="alt">Northwestern Medicine</span></a> 
          <div class="arrow">&nbsp;</div>
        </div>
    </div>
...
<#-- DON'T RENDER USER/SECONDARY NAVIGATION TO PUBLIC -->
