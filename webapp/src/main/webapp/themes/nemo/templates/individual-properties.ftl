		 ...
		 <div class="panel panel-default"> 
			   <div class="panel-heading">
				...
				<#if rangeClass == "Authorship" && individual.editable && (property.domainUri)?? && property.domainUri?contains("Person")>
					<h3 class="${property.localName}-${rangeClass}" title="${property.publicDescription!}" class="panel-title">${property.name} <@p.addLink property editable /> <@p.verboseDisplay property /> 
				...
				<#elseif rangeClass == "Authorship" && !individual.editable && (property.domainUri)?? && property.domainUri?contains("Person")>
					<h3 class="${property.localName}-${rangeClass}" 
						title="${property.publicDescription!}" 
				...
				<div class="panel-body">
					<div class="property-list" style="width:100%;" role="list" class="${property.localName}-${rangeClass}-List" displayLimit="${limit}">
					<#-- data property -->
