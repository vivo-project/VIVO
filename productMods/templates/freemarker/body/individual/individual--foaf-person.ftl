...
<div about="${individual.uri}">
    ...
    <section id="individual-intro" class="vcard person" role="region">
        ...
        <section id="share-contact" role="region"> 
            ...
            <#-- Email -->    
            <#assign emailProperty = "${core}email">
            <#assign email = propertyGroups.getPropertyAndRemoveFromList(emailProperty)!>      
                        ...
                        <#list email.statements as statement>
                            <li role="listitem">
                                ...
                                <a class="email" href="mailto:${statement.value}">
                                    <@p.dataPropertyStatement email>${statement.value}</@p.dataPropertyStatement>
                                </a>
                    ...
                    <ul id="individual-phone" role="list">
                        <#list phone.statements as statement>
                            <li role="listitem">                           
                                ...
                                <@p.dataPropertyStatement phone>${statement.value}</@p.dataPropertyStatement>
            ...
            <header>
                ...
                <#else>                
                    <h1 class="fn foaf-person">
                        ...
                        <#assign titleProperty = "${core}preferredTitle">
                        <#assign title = (propertyGroups.getProperty(titleProperty).firstValue)! />
                        <#if ! title?has_content>
                            <#assign title = individual.moniker>
                            <#assign titleProperty = "${namespaces.vitro}moniker">
                        </#if>
                        <#if title?has_content>
                            <span class="preferred-title" property="${titleProperty}">${title}</span>
                        </#if>
                    </h1>
                </#if>
