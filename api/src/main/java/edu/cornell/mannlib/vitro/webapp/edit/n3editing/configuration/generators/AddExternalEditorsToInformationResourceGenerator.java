 ...
 */
public class AddExternalEditorsToInformationResourceGenerator extends VivoBaseGenerator implements EditConfigurationGenerator {
    public static Log log = LogFactory.getLog(AddExternalEditorsToInformationResourceGenerator.class);
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq,
        ...
        //template file
        editConfiguration.setTemplate("addExternalEditorsToInformationResource.ftl");
        //add validators
        editConfiguration.addValidator(new FirstAndLastNameValidator("personUri",I18n.bundle(vreq)));
		
		//has been added on 2020-07-16 to check, if it affects links of editors being created
    ...
    private static String EDITORSHIPS_QUERY = " \n"
	    ...
	    + "	 bind (concat(str(?lastName1 + \", \"),str(?middleName1 + \" \"),str(?firstName1)) as ?editorName) . \n"
        + "} } ORDER BY ?rank";
