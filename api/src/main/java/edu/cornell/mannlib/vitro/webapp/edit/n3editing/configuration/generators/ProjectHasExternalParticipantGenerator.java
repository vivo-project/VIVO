...
public class ProjectHasExternalParticipantGenerator  extends VivoBaseGenerator implements EditConfigurationGenerator{
    ...
    public EditConfigurationVTwo getEditConfiguration(VitroRequest vreq, HttpSession session) throws Exception {
        ...
        conf.setTemplate("projectHasExternalParticipant.ftl");
    ...
    final static String n3ForNewPerson  =
		...
		//"?newPerson a <http://www.w3.org/2006/vcard/ns#Individual> . \n" +
