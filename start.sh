...
if [ ! -f $VIVO_HOME_DIR/config/runtime.properties ] || [[ "$RECONFIGURE" = "true" ]]
then
  ...
  echo "Copying /tmp/runtime.properties to /$VIVO_HOME_DIR/config/runtime.properties"
  cp -r /tmp/runtime.properties $VIVO_HOME_DIR/config/runtime.properties
else
...
if [ ! -f $VIVO_HOME_DIR/config/applicationSetup.n3 ] || [[ "$RECONFIGURE" = "true" ]]
then
  echo "Copying /tmp/applicationSetup.n3 to $VIVO_HOME_DIR/config/applicationSetup.n3"
  cp -r /tmp/applicationSetup.n3 $VIVO_HOME_DIR/config/applicationSetup.n3
else
